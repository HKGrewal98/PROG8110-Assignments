...
const orderStateMsg = {
    ...
    "toppings": "What toppings would you like?\n" + "Enter 1 for Marinara sauce, Picklse, Broccoli and Chicken breast\n" + "Enter 2 for Green peppers, Black olives, Avocado and Spinach \n"
        + "Enter 3 for Mushrooms, Onions, Prosciutto and Cheese\n" + "Enter 4 for Greek yogurt, Teriyaki Sauce, Canadian bacon and Ranch Dressing\n" + "Enter 5 to Skip.",
        ...
        try {
            switch (this.stateCur) {
                ...
                case OrderState.TOPPINGS:
                    ...
                    var choice = parseInt(sInput)
                    switch (choice) {
                        case 1: { this.sToppings = "Marinara sauce, Picklse, Broccoli and Chicken breast"; break; }
                        case 2: { this.sToppings = "Green peppers, Black olives, Avocado and Spinach"; break; }
                        case 3: { this.sToppings = "Mushrooms, Onions, Prosciutto and Cheese"; break; }
                        case 4: { this.sToppings = "Greek yogurt, Teriyaki Sauce, Canadian bacon and Ranch Dressing"; break; }
                        case 5: { break; }
                        default: {
                            orderStateValidateInput[this.stateCur.description] = false
